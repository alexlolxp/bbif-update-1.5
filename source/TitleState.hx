...
class TitleState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['BBIF Made By'], 45);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Advide', 45);
					addMoreText('BBIF Team', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Special thanks'], -60);
				case 7:
					addMoreText('Mystman12', -60);
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('In'); // credTextShit.text += '\nFunkin';
